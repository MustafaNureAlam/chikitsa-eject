...
async function getNurseEndAppointmentData(){
    ...
    await fetch( config.baseUrl + "nurse/upcoming_appointments", requestOptions)
...
async function getNurseProfile() {
    ...
    await fetch(config.baseUrl + "nurse/user", requestOptions)
    .then(response => response.text())
    .then(result => {
...
async function createRoom(appointment_id) {
    ...
    await fetch(config.baseUrl + "nurse/create_room/"+appointment_id, requestOptions)
        .then(response => response.text())
        .then(result => {
...
module.exports = {
    getNurseEndAppointmentData: getNurseEndAppointmentData,
