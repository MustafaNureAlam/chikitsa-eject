...
export default function FridayVideo({navigation, route}) {

    const [day_id, setDayId] = useState('5');
    ...
    async function getDoctorSlots() {
        ...
        await fetch( app_config.baseUrl + "doctor/my_slots/5", requestOptions)
        .then(response => response.text())
        .then(result => {
            let doctor_slot_data = JSON.parse(result);
            console.log('=====friday=====', doctor_slot_data)
