...
export default function WednesdayVideo({navigation, route}) {

    const [day_id, setDayId] = useState('3');
    ...
    async function getDoctorSlots() {
        ...
        await fetch( app_config.baseUrl + "doctor/my_slots/3", requestOptions)
