...
export default function MondayVideo({navigation,route}) {

    const [day_id, setDayId] = useState('1');
    ...
    function create_slot() {
        navigation.navigate('CreateVideoCallServiceScreen',day_id)
    }
    ...
    async function getDoctorSlots() {
        ...
        await fetch( app_config.baseUrl + "doctor/my_slots/1", requestOptions)
        .then(response => response.text())
        .then(result => {
            let doctor_slot_data = JSON.parse(result);
            console.log('=====monday=====', doctor_slot_data)
              ...
              { 
                text: "Yes", onPress: async() => 
                
                    {
                        ...
                        await fetch( app_config.baseUrl + "doctor/slot_remove", requestOptions)
                        .then(response => response.text())
                        .then(result => {
                            console.log(result)
                                                                ...
                                                                <View style={{
                                                                    ...
                                                                    <View style={{
                                                                        ...
                                                                        <TouchableOpacity style={{
                                                                            ...
                                                                            onPress={() => {
                                                                                navigation.navigate('CreateVideoCallServiceScreen',{data : item, from : 'update'})
                                                                            }}
                                                                        >
                                                                            <MaterialCommunityIcons 
