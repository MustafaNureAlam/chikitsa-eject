...
export default function Monday({navigation,route}) {
    ...
    function create_slot() {
        navigation.navigate('CreateVoiceCallServiceScreen',day_id)
    }
                                                                ...
                                                                <View style={{
                                                                    ...
                                                                    <View style={{
                                                                        ...
                                                                        <TouchableOpacity 
                                                                            ...
                                                                            onPress={() => {
                                                                                navigation.navigate('CreateVoiceCallServiceScreen',{data : item, from : 'update'})
                                                                            }}
                                                                        >
                                                                            <MaterialCommunityIcons 
