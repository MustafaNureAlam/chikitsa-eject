...
export default function MondayChat({navigation, route}) {
    ...
    function create_slot() {
        navigation.navigate('CreateChatServiceScreen',day_id)
    }
                                                                ...
                                                                <View style={{
                                                                    ...
                                                                    <View style={{
                                                                        ...
                                                                        <TouchableOpacity style={{
                                                                            ...
                                                                            onPress={() => {
                                                                                navigation.navigate('CreateChatServiceScreen',{data : item, from : 'update'})
                                                                            }}
                                                                        >
                                                                            <MaterialCommunityIcons 
