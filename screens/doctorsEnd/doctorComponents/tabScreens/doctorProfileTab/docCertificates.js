...
export default function DocCertificateScreen({navigation, route}) {
    ...
    async function getDoctorCertificate() {
        ...
        await fetch( config.baseUrl + "doctor/certificates", requestOptions)
    ...
    function editDocCertificate() {
        ...
        navigation.navigate('UpdateDoctorCertificateScreen',selected_Certi);
                            ...
                            ListHeaderComponent={
                                <View style={{
                                    ...
                                    <TouchableOpacity 
                                        ...
                                        onPress={() => navigation.navigate('CreateDocCertificateScreen')}
                                    >
