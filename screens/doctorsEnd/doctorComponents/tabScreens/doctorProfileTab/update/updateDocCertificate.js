...
export default function UpdateDoctorCertificateScreen({navigation, route}) {
    ...
    async function updateDoctorCertificate() {
        ...
        await fetch( app_config.baseUrl + "doctor/certificate_update/" + certificate_id, requestOptions)
