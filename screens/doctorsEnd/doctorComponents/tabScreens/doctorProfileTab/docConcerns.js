...
export default function DocConcernsScreen({navigation}) {
    ...
    async function getDoctorConcernsList() {
        ...
        await fetch( config.baseUrl + "doctor/doctor_concerns", requestOptions)
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity 
                                            ...
                                            onPress={() => navigation.navigate('CreateDocConcernScreen')}
                                        >
