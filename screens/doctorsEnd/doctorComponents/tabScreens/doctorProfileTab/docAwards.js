...
export default function DocAwardsScreen({navigation}) {
    ...
    async function getDoctorAwards() {
        ...
        await fetch( config.baseUrl + "doctor/doctor_awards", requestOptions)
        ...
        .then(result => {
            ...
            setLoading(false);
            // console.log('=========doc_awards===',doc_awards_data);
        })
    ...
    function editDocAwards() {
        ...
        navigation.navigate('UpdateDocAwardsScreen',selected_awards);
                                    ...
                                    renderItem={({ item, index }) => (
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Image style={{ width: 60, height: 60, borderRadius:8 }}
                                    ...
                                    ListHeaderComponent={
                                        <View style={{
                                            ...
                                            <TouchableOpacity 
                                                ...
                                                onPress={() => navigation.navigate('CreateDocAwardsScreen')}
                                            >
