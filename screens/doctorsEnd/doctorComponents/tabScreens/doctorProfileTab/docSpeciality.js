...
export default function DocSpecialityScreen({navigation}) {
    ...
    async function getDoctorSpecialization() {
        ...
        await fetch( config.baseUrl + "doctor/doctor_specializations", requestOptions)
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity 
                                            ...
                                            onPress={() => navigation.navigate('CreateDocSpecialityScreen')}
                                        >
