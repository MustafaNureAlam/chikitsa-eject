...
export default function MedicineGenericScreen({navigation, route}) {
    ...
    async function searchMedicine() {
        ...
        await fetch( config.baseUrl + "medicine/search_generic", requestOptions)
        .then(response => response.text())
        .then(result => {
            ...
            
                                                    {
                                                        api_data?.data.length > 0 ? (
                                                            ...
                                                            <TouchableOpacity 
                                                                ...
                                                                onPress={() => navigation.navigate('GenericMedicineName',{ title : item?.name, data : item, path : "generic" })}
                                                            >
                                                                <View>
                                                                    <Text style={{
                                                                        color:'#808080',
