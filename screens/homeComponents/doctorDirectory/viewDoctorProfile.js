...
import doctImage from '../../../assets/doctorProfile.png'

export default function ViewDoctorProfileScreen({navigation, route}) {
    ...
    useEffect(() => {
        if(isMounted){
            ...
            if(route_data.reg_type === "Medical"){
