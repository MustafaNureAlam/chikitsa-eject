...
export default function NurseDetailsConcernScreen({navigation, route}) {
    ...
    async function getNurseSchedule() {
        if(doctor_appoint_props.doctor_user_id){
            let nurse_schedule_data = await patientEnd.nurseSchedule(doctor_appoint_props)
            setLoading(true);
            setScheduledata(nurse_schedule_data)
            setIsSlot(true);
            setLoading(false);
            // console.log('=============')
            // console.log(nurse_schedule_data)
            // console.log('=============')
        }
    }
    ...
    function pay_proceed() {
        console.log('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
        console.log(doctor_appoint_props)
        console.log('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@')
        // navigation.reset
        // navigation.reset({
        //     index: 0,
                                ...
                                <View style={{
                                    ...
                                    <View>
                                        <Avatar.Image 
                                            ...
                                            source={{uri : config.baseUrl + 'uploades/' + doc_details?.iamge}} 
                                        />
                                    </View>
