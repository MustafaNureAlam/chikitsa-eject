...
export default function SpecialityScreen({navigation}) {
    ...
    async function allSpecialityList() {
        if(isMounted){
            setLoading(true);
            let speciality_data = await patientEnd.speciality()
    ...
    function selected_ids(doctor_id) {
        ...
        navigation.navigate('DocBySpecialityScreen',doctor_id);
    }
