...
export default function NurseConcernsScreen({navigation, route}) {
    ...
    async function getDoctorConcernsList() {
        ...
        await fetch( config.baseUrl + "nurse/concerns", requestOptions)
        .then(response => response.text())
        .then(result => {
            let doc_concern_list = JSON.parse(result);
            if(isMounted){
                // console.log('-----doc_concern_list-----',doc_concern_list)
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <TouchableOpacity 
                                            ...
                                            onPress={() => navigation.navigate('CreateNurseConcernScreen')}
                                        >
