...
export default function NurseEducationScreen({navigation, route}) {
    ...
    async function getDoctorEducation() {
        ...
        await fetch( config.baseUrl + "nurse/educations", requestOptions)
    ...
    function editDocEducation() {
        ...
        navigation.navigate('UpdateNurseEducationScreen',selected_edu);
                                    ...
                                    ListHeaderComponent={
                                        <View style={{
                                            ...
                                            <TouchableOpacity 
                                                ...
                                                onPress={() => navigation.navigate('CreateNurseEducationScreen')}
                                            >
