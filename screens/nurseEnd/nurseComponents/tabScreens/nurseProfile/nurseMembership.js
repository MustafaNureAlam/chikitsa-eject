...
export default function NurseMembershipScreen({navigation, route}) {
    ...
    async function getDoctorMembership() {
        ...
        await fetch( config.baseUrl + "nurse/memberships", requestOptions)
    ...
    function membership_update(item) {
        ...
        navigation.navigate('UpdateNurseMembershipScreen',item);
    }
    return (
                                    ...
                                    ListHeaderComponent={
                                        <View style={{
                                            ...
                                            <TouchableOpacity 
                                                ...
                                                onPress={() => navigation.navigate('CreateNurseMembershipScreen')}
                                            >
