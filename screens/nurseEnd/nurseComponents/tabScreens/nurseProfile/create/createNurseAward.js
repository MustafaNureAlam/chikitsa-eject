...
export default function CreateNurseAwardsScreen({navigation}) {

    const [award_name, setAwardName] = useState("");
    const [award_year, setAwardYear] = useState("");
    ...
    async function createDoctorAwards() {
        ...
        await fetch( app_config.baseUrl + "nurse/awards_store", requestOptions)
        ...
        .then(result => {
            ...
            if(user_data_response.code == 200) {
                Popup.show({
                    ...
                    title: 'Award added',
                    button: true,
                    textBody: 'Congrats! successfully added award',
                    buttonText: 'Ok',
                    callback: () => {
                        Popup.hide()
