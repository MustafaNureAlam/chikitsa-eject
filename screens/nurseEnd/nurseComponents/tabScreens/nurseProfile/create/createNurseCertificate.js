...
export default function CreateNurseCertificateScreen({navigation}) {
    ...
    async function createCertificate() {
        ...
        await fetch( app_config.baseUrl + "nurse/certificate_store", requestOptions)
        ...
        .then(result => {
            ...
            if(user_data_response.code == 200) {
                Popup.show({
                    ...
                    button: true,
                    textBody: 'Congrats! successfully added certificate',
                    buttonText: 'Ok',
                    // autoClose: true,
                    callback: () => {
                        Popup.hide()
