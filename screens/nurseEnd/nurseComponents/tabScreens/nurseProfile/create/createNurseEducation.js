...
export default function CreateNurseEducationScreen({navigation}) {
    ...
    async function createEducation() {
        ...
        await fetch( app_config.baseUrl + "nurse/education_store", requestOptions)
        ...
        .then(result => {
            ...
            if(user_data_response.code == 200) {
                Popup.show({
                    ...
                    button: true,
                    textBody: 'Congrats! successfully created education',
                    buttonText: 'Ok',
                    // autoClose: true,
                    callback: () => {
                        Popup.hide()
