...
export default function UpdateNurseMembershipScreen({navigation, route}) {
    ...
    async function updateDoctorMembership() {
        ...
        await fetch( app_config.baseUrl + "nurse/memberships_update/" + member_card_id , requestOptions)
        ...
        .then(result => {
            ...
            if(memberUpdated_data.code == 200) {
                Popup.show({
                    ...
                    button: true,
                    textBody: 'Congrats! successfully updated Membership',
                    buttonText: 'Ok',
                    // autoClose: true,
                    callback: () => {
                        Popup.hide()
