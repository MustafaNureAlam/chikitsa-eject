...
export default function UpdateNurseCertificateScreen({navigation, route}) {

    console.log('route',route)
    const certificate_id = route.params.id
    const [certi_name, setCertificateName] = useState(route.params?.deg_name);
    ...
    async function updateDoctorCertificate() {
        ...
        formData.append('deg_name',  certi_name );
        ...
        await fetch( app_config.baseUrl + "nurse/certificate_update/" + certificate_id, requestOptions)
        ...
        .then(result => {
            ...
            if(user_data_response.code == 200) {
                Popup.show({
                    ...
                    button: true,
                    textBody: 'Congrats! successfully updated certificate',
                    buttonText: 'Ok',
                    callback: () => {
                        Popup.hide()
                    ...
                    <View>
                        <View style={{marginHorizontal:20,marginVertical:10}} >
                            ...
                            <View style={{marginVertical:7}}>
                                <TextInput
                                    label="Degree Name"
                                    value={certi_name}
                                    onChangeText={org => setCertificateName(org)}
                                    mode={'flat'}
                            ...
                            <View style={{marginVertical:7}}>
                                <TextInput
                                    label="Medical Name"
                                    value={medical_name}
                                    onChangeText={me_name => setMedicalName(me_name)}
                                    mode={'flat'}
                                    activeUnderlineColor={'#3AAD94'}
                                    keyboardType='ascii-capable'
                                />
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity 
                                ...
                                onPress={()=> updateDoctorCertificate()}
                            >
                                <Text style={{
                                    fontSize:16,
                                    fontWeight:'bold',
